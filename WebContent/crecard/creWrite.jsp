...
// 		$ev_page.css("top",top+"px");
	...
	function validation(){
		var crecardWrite=eval("document.crecardWrite");

		if(!crecardWrite.subject.value){
			alert("카드명을 입력해주세요.");
			return false;
		}
		if(!crecardWrite.content.value){
			alert("내용을 입력해주세요.");
			return false;
		}
		if(!crecardWrite.upload.value){
			alert("첨부파일을 올려주세요.");
			return false;
		}
...
<center><b>신용카드</b>
<br/>
<form method="post" name="crecardWrite" action="crecardwriteAction.action" enctype="multipart/form-data" onsubmit="return validation();">
