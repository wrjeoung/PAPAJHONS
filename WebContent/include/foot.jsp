...
<script>
  ...
  ga('send', 'pageview');
    ...
    <address>
    	...
    	전화:1566-0889
    	팩스:02-515-8448
    	copyright 2013 파파존스 All Reights Reserved.
    </address>
...
<script language='javascript'>
	if(typeof EL_GUL == 'undefined')
	{
		...
		var _PR = location.protocol=="https:"?"https://"+EL_GUL:"http://"+EL_GUL+":"+EL_GPT;if( _bn.indexOf("Netscape") > -1 || _bn=="Mozilla"){ setTimeout("_AIMG.src = _PR+'/?cookie';",1); } else{ _AIMG.src = _PR+'/?cookie'; };
		//document.writeln("<scr"+"ipt language='javascript' src='/acecounter/acecounter_V70.js'></scr"+"ipt>");
	}
</script>
<script language='javascript' src='/assets/js/acecounter/acecounter_V70.js'></script>
<noscript><img src='http://dgc11.acecounter.com:8080/?uid=BP4C38568511430&je=n&' border=0 width=0 height=0></noscript>
