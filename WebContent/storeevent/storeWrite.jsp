...
// 		$ev_page.css("top",top+"px");
	...
	function validation(){
		var storeWrite=eval("document.storeWrite");

		if(!storeWrite.store.value){
			alert("매장명을 입력하세요.");
			return false;
		}
		if(!storeWrite.day.value){
			alert("기간을 입력하세요.");
			return false;
		}
		if(!storeWrite.subject.value){
			alert("글제목을 입력하세요.");
			return false;
		}
	}
...
<center><b>매장별 이벤트</b>
<br/>
<form method="post" name="storeWrite" action="storewriteAction.action" enctype="multipart/form-data" onsubmit="return validation();">
	<table width="600" border="1" cellspacing="0" cellpadding="0" align="center">
		<tr>
			<td width="70" align="center">매장</td>
			<td width="530">
				<input type="text" size="70" maxlength="50" name="store">
			</td>
		</tr>
		<tr>
